...
///
/// \brief The YOLOv5_bb_onnx class
///
class YOLOv5_bb_onnx : public YoloONNX
{
public:
	YOLOv5_bb_onnx(std::vector<std::string>& inputTensorNames, std::vector<std::string>& outputTensorNames)
	{
